function load(xbrlDoc) {
  ...
  self.xbrl.fields['Revenues'] =
    self.xbrl.getFactValue('us-gaap:Revenues', 'Duration') ||
  ...
  self.xbrl.fields['CostOfRevenue'] =
    self.xbrl.getFactValue('us-gaap:CostOfRevenue', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:CostOfServices', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:CostOfGoodsSold', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:CostOfGoodsAndServicesSold', 'Duration') ||
    0;

  // GrossProfit
  self.xbrl.fields['GrossProfit'] =
    self.xbrl.getFactValue('us-gaap:GrossProfit', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:GrossProfit', 'Duration') ||
    0;

  // OperatingExpenses
  self.xbrl.fields['OperatingExpenses'] =
    self.xbrl.getFactValue('us-gaap:OperatingExpenses', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:OperatingCostsAndExpenses', 'Duration') ||
    0;

  // CostsAndExpenses
  self.xbrl.fields['CostsAndExpenses'] =
    self.xbrl.getFactValue('us-gaap:CostsAndExpenses', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:CostsAndExpenses', 'Duration') ||
    0;

  // OtherOperatingIncome
  self.xbrl.fields['OtherOperatingIncome'] =
    self.xbrl.getFactValue('us-gaap:OtherOperatingIncome', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:OtherOperatingIncome', 'Duration') ||
    0;

  // OperatingIncomeLoss
  self.xbrl.fields['OperatingIncomeLoss'] =
    self.xbrl.getFactValue('us-gaap:OperatingIncomeLoss', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:OperatingIncomeLoss', 'Duration') ||
    0;

  // NonoperatingIncomeLoss
  self.xbrl.fields['NonoperatingIncomeLoss'] =
    self.xbrl.getFactValue('us-gaap:NonoperatingIncomeExpense', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:NonoperatingIncomeExpense', 'Duration') ||
    0;

  // InterestAndDebtExpense
  self.xbrl.fields['InterestAndDebtExpense'] =
    self.xbrl.getFactValue('us-gaap:InterestAndDebtExpense', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:InterestAndDebtExpense', 'Duration') ||
    0;
  ...
  self.xbrl.fields['IncomeTaxExpenseBenefit'] =
    self.xbrl.getFactValue('us-gaap:IncomeTaxExpenseBenefit', 'Duration') ||
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields['ExtraordaryItemsGainLoss'] =
    self.xbrl.getFactValue('us-gaap:ExtraordinaryItemNetOfTax', 'Duration') ||
    self.xbrl.getFactValue('us-gaap:ExtraordinaryItemNetOfTax', 'Duration') ||
    0;

  // NetIncomeLoss
  self.xbrl.fields['NetIncomeLoss'] =
    self.xbrl.getFactValue('us-gaap:ProfitLoss', 'Duration') ||
  ...
  self.xbrl.fields['NetIncomeAttributableToParent'] =
    self.xbrl.getFactValue('us-gaap:NetIncomeLoss', 'Duration') || 0;
  ...
  self.xbrl.fields['ComprehensiveIncome'] =
    ...
    self.xbrl.getFactValue('us-gaap:ComprehensiveIncomeNetOfTax', 'Duration') ||
    0;
